    ...
    <el-container>
      <el-header>
        ...
        >
          ...
          <el-menu-item index="/userHome/userHouseShow">房屋展示</el-menu-item>
          ...
          <el-menu-item index="/userHome/userHouseBuy">购买申请</el-menu-item>
          <el-menu-item index="/userHome/userContract">我的合同</el-menu-item>
